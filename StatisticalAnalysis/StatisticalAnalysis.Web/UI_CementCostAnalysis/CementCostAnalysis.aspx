<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CementCostAnalysis.aspx.cs" Inherits="StatisticalAnalysis.Web.UI_CementCostAnalysis.CementCostAnalysis" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="/UI_CementCostAnalysis/js/page/CementCostAnalysis.js"></script>
                ...
                <div class="easyui-panel queryPanel" data-options="region:'north', border:true, collapsible:false, split:false" style="height: 80px;">
                    <table>
                        <tr>
                            <td>组织机构：</td>
                            <td>
                                <input id="txtOrganization" class="easyui-textbox" data-options="editable:false" style="width: 120px;" /><input id="organizationId" readonly="true" style="display: none;" /></td>
                            <td>|</td>
                            <td>选择水泥品种：</td>
                            <td>
                            <input id="cementItem" class="easyui-combobox" name="cementType" />
                             </td>
                            </tr>
                        </table>
