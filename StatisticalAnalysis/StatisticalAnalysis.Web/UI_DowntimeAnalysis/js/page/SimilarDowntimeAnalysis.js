...
function Query() {
    ...
    // 获取停机原因
    var reasonLevelCode = $('#downtimeReason').combotree('getValue');
    if (reasonLevelCode == undefined || reasonLevelCode == null) {
        reasonLevelCode = "";
    }
    ...
    $.ajax({
        ...
        data: "{organizationId:'" + organizationId + "',analysisType:'" + analysisType + "',startTime:'" + startTime + "',endTime:'" + endTime + "',reasonLevelCode:'" + reasonLevelCode + "'}",
