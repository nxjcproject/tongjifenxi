<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ComprehensiveAnalysis.aspx.cs" Inherits="StatisticalAnalysis.Web.UI_DowntimeAnalysis.ComprehensiveAnalysis" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <link type="text/css" rel="stylesheet" href="/UI_DowntimeAnalysis/css/page/ComprehensiveAnalysis.css" />
    ...
    <script type="text/javascript" src="/UI_DowntimeAnalysis/js/page/ComprehensiveAnalysis.js"></script>
</head>
<body>
    <div class="easyui-layout" data-options="fit:true,border:false">
        ...
        <div class="easyui-panel" data-options="region:'center',border:false">
            <div class="easyui-layout" data-options="fit:true,border:false" style="margin-left:5px;">
                ...
                <!-- 工具栏结束 -->
                <!-- 统计信息开始 -->
                <div class="easyui-panel countPanel" data-options="region:'west',title:'停机统计',border:true,collapsible:true,split:false">
                    <fieldset>
                        <legend>合计</legend>
