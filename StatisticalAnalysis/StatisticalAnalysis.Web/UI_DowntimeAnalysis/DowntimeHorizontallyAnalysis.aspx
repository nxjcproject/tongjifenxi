            ...
            <table>
                <tr>
                    ...
                    <td style="width: 130px;">
                        <select id="Select_EquipmentCommonInfoF" class="easyui-combobox" data-options="valueField: 'id', textField: 'text',panelHeight: 'auto', editable:false" name="EquipmentCommonInfo" style="width: 120px;">
                        </select>
                    </td>
                    <th style="width: 80px;">
                    </th>
                ...
                <tr>
                    ...
                    <th style="width: 80px;">停机类型</th>
                    <td  style="width: 130px;">
                        <select id="ComboTree_ReasonTypeInfoF" class="easyui-combotree" name="ReasonInfo" data-options="valueField: 'id',
                                   textField: 'text', required: false,panelHeight: 'auto', editable: false" style="width: 120px;">
                        </select>
                    </td>
                    <th style="width: 80px;">
