<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HistoryTrend_Materials.aspx.cs" Inherits="StatisticalAnalysis.Web.UI_BasicHistoryTrend.MaterialsQuantityTrend" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="js/page/HistoryTrend_Materials.js" charset="utf-8"></script>
</head>
<body>
                            ...
                            <table id="processTable" class="easyui-treegrid"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th data-options="field:'Name',width:100,editor:'text'">物料名称</th>
                                    </tr>
                                </thead>
                            </table>
                            <!-- 工序表格结束 -->
