...
function Query() {
    ...
    $.ajax({
        type: "POST",
        url: "AlarmCountAnalysis.aspx/GetAlarmChart",
        data: "{organizationId:'" + organizationId + "',analysisType:'" + analysisType + "',startTime:'" + startTime + "',endTime:'" + endTime + "',alarmType:'" + alarmType + "'}",
...
//网上找到的资料解决ie8下不兼容new Date（"2015-01-01"）的问题
