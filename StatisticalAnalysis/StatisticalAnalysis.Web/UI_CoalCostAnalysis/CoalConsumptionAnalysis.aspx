<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CoalConsumptionAnalysis.aspx.cs" Inherits="StatisticalAnalysis.Web.UI_CoalCostAnalysis.CoalConsumptionAnalysis" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript" src="/UI_CoalCostAnalysis/js/page/CoalConsumptionAnalysis.js"></script>
        ...
        <div class="easyui-panel" data-options="region:'center',border:false">
            <div class="easyui-layout" data-options="fit:true,border:false" style="margin-left:5px;">
                ...
                <tr>
                    <%--<td>
                        |
                    <select id="Select1" class="easyui-combobox" data-options="panelHeight: 'auto'" name="imageType" style="width:100px;">
                        <option value="Line">趋势图</option>
                        <option value="Bar">柱状图</option>
                    </select>
                        </td>--%>
