<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SimilarDowntimeAnalysis.aspx.cs" Inherits="StatisticalAnalysis.Web.UI_DowntimeAnalysis.SimilarDowntimeAnalysis" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <link type="text/css" rel="stylesheet" href="/UI_DowntimeAnalysis/css/page/SimilarDowntimeAnalysis.css" />
    ...
    <script type="text/javascript" src="/UI_DowntimeAnalysis/js/page/SimilarDowntimeAnalysis.js"></script>
            ...
            <div class="easyui-layout" data-options="fit:true,border:false" style="margin-left:5px;">
                ...
                <div class="easyui-panel queryPanel" data-options="region:'north', border:true, collapsible:false, split:false" style="height: 80px;">
                    <table>
                        <tr>
                            <td>组织机构：</td>
                            <td><input id="txtOrganization" class="easyui-textbox" data-options="editable:false" style="width: 200px;" /><input id="organizationId" readonly="true" style="display:none;"/></td>
                        ...
                        <tr>
                            <td>停机原因：</td>
                            <td>
                                <input id="downtimeReason" class="easyui-combotree" name="downtimeReason" data-options="editable:true, required:false" style="width:200px;" />
                            </td>
                            <td style="width:10px;">|</td>
                            <td>图表类型：</td>
                            <td>
                                <select id="imageType" class="easyui-combobox" data-options="panelHeight: 'auto'" name="imageType" style="width:190px;">
