...
namespace StatisticalAnalysis.Web.UI_DowntimeAnalysis
{
    public partial class DowntimeCountAnalysis : WebStyleBaseForEnergy.webStyleBase
    {
        ...
        [WebMethod]
        public static string GetDowntimeChart(string organizationId, string analysisType, string startTime, string endTime, string reasonLevelCode = "")
        {
            ...
            switch (analysisType)
            {
                case "yearly":
                    xaxisLabel = "月";
                    downtimeCountTable = DowntimeCountAnalysisService.GetDowntimeLogYearly(organizationId, end.Year, reasonLevelCode);
                    break;
                case "monthly":
                    xaxisLabel = "月-日";
                    downtimeCountTable = DowntimeCountAnalysisService.GetDowntimeLogMonthly(organizationId, end.Year, end.Month, reasonLevelCode);
                    break;
                case "custom":
                    xaxisLabel = "年-月-日";
                    downtimeCountTable = DowntimeCountAnalysisService.GetDowntimeLogCustom(organizationId, begin, end, reasonLevelCode);
                    break;
                default:
                    break;
            }
